function Help() {
  return (
    <div className="scrollbar-thin max-h-[420px] overflow-y-auto rounded-lg bg-gray-800 p-2 font-avenir shadow-md md:p-6">
      ...
      <p className="mb-3">
        <b>1). </b>Place a bet "trade" and watch the multiplier increase!
        <br />
      ...
      <p className="mb-3">
        ...
        <br />
        <b>A:</b> When the game is running press the 'Cash Out' button to STOP
        the multiplier. This button appears if you placed a bet.
      </p>
      <p className="mb-3">
