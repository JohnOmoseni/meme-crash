...
export class MemeCrashChild implements Contract {
    ...
    static async init(id: bigint) {
        return await MemeCrashChild_init(id);
    }
    
    static async fromInit(id: bigint) {
        const init = await MemeCrashChild_init(id);
